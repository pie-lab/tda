...
data = read.csv("~/Downloads/PROPOSE UPDATE DROPS 20479 23832 TDA_data_scored.csv")
masterKey = read.csv("~/Downloads/PROPOSED UPDATE REMOVED TALL x 2 false blase masterkey.csv")
...
frequencies = read.csv("~/Downloads/PROPOSED ADDITIONAL FILE TDA_frequencies.csv")
...
item_prop %>%
  DT::datatable( # put into interactive HTML table
    colnames = c("Adjective", "N (total)", "Proportion Correct", "COCA frequency", "GBooks frequency", "G&N1710"), #colnames
...
write_csv(item_prop, file = "~/Downloads/tda_properties.csv")
```

...
write.csv(data_scored, file = here("data/TDA_data_scored.csv"))
```
...
write.csv(data_recode, file = here("data/TDA_data_recoded.csv"))
```
...
```{r, results = 'asis'}
alldata_scored = alldata_scored[-which(demo$included == "No"), ]

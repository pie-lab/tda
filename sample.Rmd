...
This page shows the demographic characteristics for the sample of participants who responded to the items. The sample contained participants from a wide range of ages, household incomes, and different geographies (by state) within the US. Slightly more than half of the sample identified as female, 73% identified as White, and the majority had some college-level education (42%) or a high school degree/GED equivalent (40%). 

...
Here we present variable names, descriptions, and summary statistics for the demographic variables and total score column present in both versions of the dataset. We omit the specific items, as there are more than 5,000 of them.
...
```{r remove_items}
codebook_data = select(codebook_data, -starts_with("q_"))
```
...
```{r variable labels}
attributes(codebook_data$PID)$label <- "Participant ID number."
